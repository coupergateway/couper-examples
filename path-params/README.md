...
The `path_params` [variable](https://github.com/coupergateway/couper/tree/master/docs#variables_conf) gets evaluated on client requests which matches an endpoint with a related parameter definition.
